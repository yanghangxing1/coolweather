package com.example.asdfg.coolweather.service;
...
public class AutoUpdateService extends Service {
    ...
    * */
    private  void updateWeather(){
        ...
        String weatherString =prefs.getString("weathr",null);
        if (weatherString!=null){
            //有缓存是直接解析天气数据
            Weather weather = Utility.handleWeatherResponse(weatherString);
            String weatherId =weather.basic.weatherId;
            String weatherUrl ="http://guolin.tech/api/weather?cityid="+weatherId+"&key=162bfd25c9c24d50b498c11b09dfec88";
